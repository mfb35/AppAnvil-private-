...
class StatusMock : public Status
{
  ...
  FRIEND_TEST(StatusTest, PARSE_JSON_NULL_VALUE);
  FRIEND_TEST(StatusTest, PARSE_JSON_STRING_VALUE);
  FRIEND_TEST(StatusTest, PARSE_JSON_INT_VALUE);
  FRIEND_TEST(StatusTest, PARSE_JSON_REAL_VALUE);
  FRIEND_TEST(StatusTest, PARSE_JSON_BOOLEAN_VALUE);
  FRIEND_TEST(StatusTest, PARSE_JSON_ARRAY_VALUE);
  FRIEND_TEST(StatusTest, PARSE_JSON_OBJECT_VALUE);
  FRIEND_TEST(StatusTest, PARSE_JSON_SAMPLE_INPUT);
};
